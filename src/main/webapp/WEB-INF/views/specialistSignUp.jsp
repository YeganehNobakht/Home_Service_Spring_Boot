...
<%--<spring:message code ="name.size" var="name.size"/>--%>
<html lang="en">
<head>
    <title>sign up</title>
    <!-- Required meta tags -->
    ...
    <link href="<p:url value="/static/css/firstPage.css"/>" rel="stylesheet"/>
...
<div class="bgc">
    ...
    <form:form modelAttribute="specialistDto" id="loginForm"  action="registerSignUp" method="post"><br><br>
        <table class="table table-striped table-hover">
            ...
            <tr>
                <td><form:label path="serviceCategory.name">Speciality:</form:label></td>
                <td><form:select path="serviceCategory.name" style="width: 202px" size="1" name="serviceCategoryList">
                    <form:option value="NONE" >...SELECT...</form:option>
                    <c:forEach items="${sessionScope.allServices}" var="list">
            ...
            <tr>
                <td></td>
                <td><form:errors path="serviceCategory.name" cssClass="text-danger"/></td>
            </tr>
            <tr>
                <td>
                    <form:label path="profilePicture" for="profilePicture">Image:</form:label>
                </td>
                <td>
                    <form:input type="file" id="profilePicture" path="profilePicture"/>
                </td>
            </tr>
            <tr>
                <td></td>
                <td>
                    <form:errors path="profilePicture" cssClass="text-danger"/>
                </td>
            </tr>
            <tr>
                <td></td>
...
<script>
    const imageFile = document.getElementById('profilePicture');
