...
<div class="m">
    ...
    <div class="m11">
        <div class="m2">
            <div class="m3">
                <div class="m5">
                    <button type="button" class="btn btn-secondary btn-lg btn-block" name="completedOrder"
                            id="completedOrder" onClick="parent.location='/customer/completeOrder'">Completed Orders
                    </button>
                </div>
                <div class="m6">
                    <button type="button" class="btn btn-secondary btn-lg btn-block" name="currentOrder"
                            id="currentOrder" onClick="parent.location='/customer/currentOrder'">Current Orders
                    </button>
                </div>
            </div>
            <div class="m4">
                ...
                <form:form modelAttribute="suggestions">
                    <table class="table table-striped table-secondary table-hover">
                        ...
                        <c:forEach items="${suggestions}" var="o">
                            <tr>
                                <td>${o.customerOrder.subCategory.name}</td>
                                <td>${o.specialistDto.name} ${o.specialistDto.lastName}</td>
