...
//                .setSuggestionList(specialist.getSuggestionList().stream().map(s -> toSuggestionDto(s)).collect(Collectors.toList()));
    ...
    public ir.maktab.service.data.entity.Suggestion toSuggestion(SuggestionDto suggestionDto) {
    ...
    public SuggestionDto toSuggestionDto(ir.maktab.service.data.entity.Suggestion suggestion) {
