            ...
            <div class="m4">
                ...
                <form>
                    <table class="table table-striped table-hover">
                        <tr>
                            <td>Service Name:</td>
                            <td>${customerOrderDto.subCategory.name}</td>
                        </tr>
                        <tr>
                            <td>Service Price:</td>
                            <td>${customerOrderDto.price}</td>
                        </tr>
                    </table>
<%--                    <button type="button" onclick="pay(${customerOrderDto.price})" class="btn btn-secondary btn-lg btn-block">Pay</button>--%>
                    <div class="m2">
                        <div class="m3">
                            <div class="m5">
                                <button type="button" class="btn btn-secondary btn-lg btn-block" name="completedOrder"
                                        id="completedOrder" onClick="parent.location='/payment/byCard'">Pay By Card
                                </button>
                            </div>
                            <div class="m6">
                                <button type="button" class="btn btn-secondary btn-lg btn-block" name="currentOrder"
                                        id="currentOrder" onClick="parent.location='/payment/byBalance'">Pay By Account Balance
                                </button>
                            </div>
                        </div>
