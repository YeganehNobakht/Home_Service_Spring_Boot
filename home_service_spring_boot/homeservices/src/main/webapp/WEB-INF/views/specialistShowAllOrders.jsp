            ...
            <div class="m3">
                <div class="m5">
                    <button type="button" class="btn btn-secondary btn-lg btn-block" name="completedOrder"
                            id="completedOrder" onClick="parent.location='/specialist/completeOrder'">Completed Orders
                    </button>
                </div>
                <div class="m6">
                    <button type="button" class="btn btn-secondary btn-lg btn-block" name="currentOrder"
                            id="currentOrder" onClick="parent.location='/specialist/currentOrder'">Current Orders
                    </button>
                </div>
            </div>
            <div class="m4">
                ...
                <img src="/static/image/showOrders.jpg" alt="" style="width: 600px;height: 280px;">
            </div>
