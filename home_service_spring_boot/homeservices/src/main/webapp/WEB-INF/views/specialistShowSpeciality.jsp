...
<html>
<head>
    <title>specialist speciality</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<nav class="navbar navbar-expand navbar-light bg-light">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="/specialist/showAllOrders"><img src="/static/image/order.png"
                                                                      ...
                                                                      class="d-inline-block align-text-top">Orders
        </a>
    </div>
</nav>
<hr>
<div class="m">
    ...
    <div class="m11 ">
        ...
        <table class="table table-striped table-secondary table-hover">
            <tr>
                <h4 class="d-flex justify-content-center text-black">Your Speciality List:</h4>
            </tr>
            <c:forEach items="${specialistServiceList}" var="o">
                <tr>
                    <td><h5 class="d-flex justify-content-center text-black">${o.name}</h5></td>
                </tr>
            </c:forEach>
        </table>
