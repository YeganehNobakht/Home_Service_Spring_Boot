...
<div class="m">
    ...
    <div class="m11">
        ...
        <form:form width="700px" modelAttribute="suggestionDto"
                   action="/suggestion/add" method="post">
            <table class="table table-bordered table-striped text-black d-flex align-items-center justify-content-center">
                <tr>
                    <td><form:label path="price">Price</form:label></td>
                    <td><form:input size="20" path="price" name="price"/></td>
                </tr>
                <tr>
                    <td></td>
                    <td><p class="text-danger">${price}</p></td>
                </tr>

                <tr>
                    <td>
                        <form:label path="startTime">Start Time</form:label></td>
                ...
                <tr>
                    <td></td>
                    <td><p class="text-danger">${durationOfWork}</p></td>
                </tr>
                <tr>
                    <td><form:label path="workDescription">Work Description</form:label></td>
                    <td><form:textarea size="20" path="workDescription" rows="3" cols="40" name="workDescription"/></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
