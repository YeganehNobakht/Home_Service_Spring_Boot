...
<div class="m">
    ...
    <div class="m11">
        ...
        <div class="box">
            <c:if test="${sessionScope.myCustomerDto ne null}">
                <h1 class="text-left info-text">Account Information</h1>
                <h5 ><strong>Full Name</strong></h5>
                <h5>${sessionScope.myCustomerDto.name} ${sessionScope.myCustomerDto.lastName}</h5>
                <h5 ><strong>Email</strong></h5>
                <h5>${sessionScope.myCustomerDto.email}</h5>
                <h5 ><strong>Balance</strong></h5>
                <h5>${sessionScope.myCustomerDto.balance} Toman</h5>
            </c:if>
    </div>
