...
<html>
<head>
    <title>specialist service</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<%--            </button>--%>
    ...
    <div class="m11 backColor">
        ...
        <h5 class="d-flex justify-content-center text-danger">${error}</h5>
            <div class="box">
                <c:if test="${sessionScope.mySpecialistDto ne null}">
                <h1 class="text-left info-text">Account Information</h1>
                <h5 ><strong>Full Name</strong></h5>
                <h5>${sessionScope.mySpecialistDto.name} ${sessionScope.mySpecialistDto.lastName}</h5>
                    <h5 ><strong>Email</strong></h5>
                    <h5>${sessionScope.mySpecialistDto.email}</h5>
                    <h5 ><strong>Balance</strong></h5>
                    <h5>${sessionScope.mySpecialistDto.balance}</h5>
                </c:if>
            </div>
    </div>
