...
<%
    ...
    Object allow = (session1.getAttribute("balance"));
...
<form:form modelAttribute="paymentDto" method="post" action="/payment/increaseBalance">

    <p class="d-flex justify-content-center align-items-center text-black">The amount payable is ${sessionScope.balance}</p>
