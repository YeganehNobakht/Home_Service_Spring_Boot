...
<div class="m">
    ...
    <div class="m11">
        ...
        <form:form width="700px" modelAttribute="customerCommentDto" id="commetnForm" action="/customer/addComment" method="post"><br><br>
            <table class="table table-striped table-hover d-flex justify-content-center">
                <tr>
                    <td><form:label path="comment" for="comment">Comment: </form:label></td>
                    <td><form:textarea  path="comment" id="comment" rows="3" cols="40"/></td>

                </tr>

                <tr>
                    <td><form:label path="score" for="lastName">Score: </form:label></td>
                    <td><form:input path="score" id="score"/></td>
                </tr>
                <tr>
                    <td></td>
                    <td><p class="text-danger">${score}</p></td>
                </tr>
                <tr>
                    <td></td>
