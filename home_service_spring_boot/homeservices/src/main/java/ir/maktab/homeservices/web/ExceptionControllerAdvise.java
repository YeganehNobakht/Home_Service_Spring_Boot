...
public class ExceptionControllerAdvise {
    ...
    @ExceptionHandler({PasswordNotFoundException.class, UserNameNotFoundException.class, TooLowSubServicePriceException.class,
            ...
            ServiceAlreadyExistException.class, DuplicateUsernameException.class,
            DuplicateEmailException.class, PasswordNotFoundException.class,
            UserNotApproveException.class})
    public ModelAndView passwordException(Exception e, HttpServletRequest request) {
        ...
        model.put("suggestionDto", new SuggestionDto());
        model.put("userDto", new UserDto());
        model.put("managerDto", new ManagerDto());
        model.put("changePass", new ChangePassDto());
